...
def get_movable_feasts():
    """Get all movable feast classes defined in this module.

    This function will introspect this module and return all subclasses inherited from the
    `MovableFeast` class.

    """
    current_module = sys.modules[__name__]
    return [
        elem[1] for elem in inspect.getmembers(current_module) if issubclass(elem[1], MovableFeast)
    ]
